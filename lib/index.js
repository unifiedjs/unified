...
function base() {
  ...
  /** @type {Processor['Parser']} */
  processor.Parser = undefined

  /** @type {Processor['Compiler']} */
  ...
  processor.stringify = function (node, doc) {
    processor.freeze()
    const file = vfile(doc)
  ...
  processor.runSync = function (node, file) {
    /** @type {Node|undefined} */
    let result
    /** @type {boolean|undefined} */
    let complete
  ...
  processor.processSync = function (doc) {
    /** @type {boolean|undefined} */
    let complete
