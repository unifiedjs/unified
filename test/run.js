...
test('run(node[, file])', function (t) {
  ...
  unified()
    ...
    .then(function () {
      t.fail(
        'should reject, not resolve, when an error is passed to `done` ' +
        'from a sync transformer'
      );
    }, function (err) {
      t.equal(
  ...
  unified()
    ...
    .then(function (tree) {
      ...
      t.fail(
        'should resolve, not reject, when a new tree is given from a ' +
        'sync transformer'
      );
    });
  ...
  unified()
    ...
    .then(function () {
      t.fail(
        'should reject, not resolve, if an error is given to a sync ' +
        'transformer’s `next`'
      );
    }, function (err) {
      t.equal(
  ...
  unified()
    ...
    .then(function (tree) {
      ...
      t.fail(
        'should resolve, not reject, if a new tree is given to a sync ' +
        'transformer’s `next`'
      );
    });
  ...
  unified()
    ...
    .then(function () {
      t.fail(
        'should reject, not resolve, if an error is rejected from a ' +
        'sync transformer’s returned promise'
      );
    }, function () {
      t.pass(
        'should reject if an error is rejected from a ' +
        'sync transformer’s returned promise'
      );
    });
  ...
  unified()
    ...
    .then(function () {
      t.pass(
        'should resolve a new tree if it’s resolved from a sync transformer’s ' +
        'returned promise'
      );
    }, function () {
      t.fail(
        'should resolve, not reject, a new tree if it’s resolved from a sync ' +
        'transformer’s returned promise'
      );
    });
  ...
  unified()
    ...
    .then(function () {
      t.pass(
        'should resolve a new tree if it’s given to `next` from ' +
        'an asynchroneous transformer'
      );
    }, function () {
      t.fail(
        'should resolve, not reject, if a new tree is given to `next` from ' +
        'an asynchroneous transformer'
      );
    });
  ...
  unified()
    ...
    .then(function () {
      t.fail(
        'should reject, not resolve, if an error is given to `next` from ' +
        'an asynchroneous transformer'
      );
    }, function () {
      t.pass(
        'should reject if an error is given to `next` from ' +
        'an asynchroneous transformer'
      );
    });
...
test('runSync(node[, file])', function (t) {
  ...
  t.equal(
    unified()
      ...
      .runSync(n),
    a,
    'should return a new tree resolved from a sync transformer’s ' +
    'returned promise'
  );
